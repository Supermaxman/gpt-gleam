...
from gpt_gleam.data import Stance, iterate_post_frame_unlabeled_pairs
...
def main(
    ...
    if total is None:
        ...
        total = sum(
            1 for _ in iterate_post_frame_unlabeled_pairs(data_path, frame_path, skip_stances=[Stance.Not_Relevant])
        )
